...
//        applyDao.setIds(applyID);
        ...
        applyDao.setId(applyModel.getId());
        applyDao.setCategory(applyModel.getCategory());
        applyDao.setHeader(applyModel.getHeader());
        applyDao.setAuthor(applyModel.getAuthor());
        applyDao.setAbstract(applyModel.getAbstract());
//        applyDao.setPublishtime(applyModel.getPublishtime());

        applyDao.setSource(applyModel.getSource());
        applyDao.setFormat(applyModel.getFormat());
        applyDao.setGrade(applyModel.getGrade());
//        applyDao.setAppraise(applyModel.getAppraise());
        applyDao.setProvider(applyModel.getProvider());
    ...
    public ApplyVO GetApplications(){
        ...
        List<ApplyModel>  allApplyInfos= new ArrayList<>();
...
//            AllApplyInfo applyInfo = new AllApplyInfo();
            ApplyModel applyInfo = new ApplyModel();

            applyInfo.setId((String) objects[0]);
            applyInfo.setAbstract((String) objects[1]);
            applyInfo.setAuthor((String) objects[2]);
            applyInfo.setCategory((int) objects[3]);
            applyInfo.setFormat((int) objects[4]);
            applyInfo.setGrade((int) objects[5]);
            applyInfo.setHeader((String) objects[6]);
            applyInfo.setProvider((String) objects[7]);
//            applyInfo.setPublishtime((Date) objects[8]);
            applyInfo.setSource((int) objects[8]);
//            applyInfo.setSource((int) objects[9]);
...
//        System.out.println(ApplyInfos.size());
//
//        List<ApplyModel>  myApplyInfos= new ArrayList<>();
//
//        for (Object[] objects : ApplyInfos) {
//
//            System.out.println(Arrays.toString(objects));
//
//            ApplyModel applyInfo = new AllApplyInfo();
//
////            applyInfo.setOpenid((String) objects[0]);
////            applyInfo.setComid((String) objects[1]);
////            applyInfo.setName((String) objects[2]);
